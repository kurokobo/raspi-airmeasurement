...
def read():
    ...
    for i in range(0xF7, 0xF7 + 8):
        raw.append(bus.read_byte_data(i2c_address, i))
    ...
    data = {
        ...
        "airpressure": compensate_P(pres_raw),
...
def compensate_H(adc_H):
    ...
    if humidity != 0:
        humidity = (adc_H - (digH[3] * 64.0 + digH[4] / 16384.0 * humidity)) * (
            digH[1]
            / 65536.0
            * (
                1.0
                + digH[5] / 67108864.0 * humidity * (1.0 + digH[2] / 67108864.0 * humidity)
            )
        )
    else:
        return 0
